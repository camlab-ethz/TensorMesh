...
The full contributor guide — dev environment setup, running the test
...
3. **Have an idea?** → float it on
   [Discussions → Ideas & RFCs](https://github.com/camlab-ethz/TensorMesh/discussions/categories/ideas-rfcs)
