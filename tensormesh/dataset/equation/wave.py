...
class WaveMultiFrequency:
    r"""Multi-frequency wave equation, with :math:`0` boundary condition 
    ...
    def initial_condition(self, points):
        r"""Generate the wave initial function at each point in the domain
        ...
        assert ((points<=1.0) & (points>=0.0)).all(), f"the points must be in [0,1]^2, but got {points}"
    ...
    def solution(self, points, t=0.1):
        r"""Generate the wave solution function at each point in the domain
