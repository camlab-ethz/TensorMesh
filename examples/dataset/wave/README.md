...
- **Initial Conditions:** 100 random samples from `WaveMultiFrequency` with $K = 16$ Fourier modes, zero initial velocity
- **Time Integration:** Central difference scheme, $c = 2.0$, $\Delta t = 0.001$, 100 steps

## Features

- **Batch solve:** Solves all 100 samples simultaneously using multi-RHS sparse LU
...
- `wave_dataset.mp4`: animation of the first sample (GPU vs CPU comparison)
